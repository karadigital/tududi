...
const TaskRecurrenceCard: React.FC<TaskRecurrenceCardProps> = ({
    ...
    const renderContent = () => (
        <div
            className={`space-y-4 ${canEdit && !isEditing ? 'cursor-pointer' : ''}`}
                ...
                <div className="space-y-4">
                    <TaskRecurrenceSection
                        ...
                        recurrenceWeekOfMonth={
                            recurrenceForm.recurrence_week_of_month || undefined
                        }
                ...
                <>
                    ...
                    (parentTask?.recurrence_type &&
                        ...
                        <div className="text-sm text-gray-600 dark:text-gray-400 text-center">
                            {t('task.notRecurring', 'Add recurrence details')}
                        </div>
                    )}
                            ...
                            <div className="mb-3">
                                <span className="text-sm font-medium text-gray-700 dark:text-gray-300">
                                    ...
                                    {!loadingIterations &&
                                        ...
                                        nextIterations.some(
                                            (iter) =>
                                                formatDateWithDayName(iter.date)
                                                    .isToday
                                        ) && (
    ...
    return (
        <div>
            <div className="rounded-lg shadow-sm bg-white dark:bg-gray-900 border-2 border-gray-50 dark:border-gray-800 hover:border-gray-200 dark:hover:border-gray-700 p-6">
                {renderContent()}
            </div>
        </div>
    );
